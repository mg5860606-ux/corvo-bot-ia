...
// Prioridade: campo com @s.whatsapp.net (número real)
const campos = [i.id, i.jid, i.participantPn, i.participant];
let jidReal = i.id;
for (const campo of campos) {
    if (campo && campo.includes('@s.whatsapp.net')) {
        jidReal = campo.replace(/:.*(?=@)/, '');
        break;
    }
}
admins.push(jidReal);
