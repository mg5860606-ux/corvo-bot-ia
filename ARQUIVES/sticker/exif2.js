...
async function writeExifImg2 (media, metadata) {
    ...
    if (metadata.packname || metadata.author) {
        ...
        const json = { "sticker-pack-id": `https://github.com/seu_github/corvo-bot`, "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "emojis": metadata.categories ? metadata.categories : [""] }
...
module.exports = { imageToWebp2, videoToWebp2, writeExifImg2, writeExifVid2, writeExif2 }