...
┇ | 🎮⋆͜͡҈➳ *${prefix}dama (marcar @)*
┇ | 🎮⋆͜͡҈➳ *${prefix}d-mov (linha,col)*
┇ | 🎮⋆͜͡҈➳ *${prefix}lig4 (marcar @)*
┇ | 🎮⋆͜͡҈➳ *${prefix}l-col (coluna)*
┇ | 🎮⋆͜͡҈➳ *${prefix}velha (marcar @)*
┇ | 🎮⋆͜͡҈➳ *${prefix}v-pos (posição)*
┇ | 🎮⋆͜͡҈➳ *${prefix}forca (@ + palavra)*
┇ | 🎮⋆͜͡҈➳ *${prefix}f-letra (letra)*
┇ | 🎮⋆͜͡҈➳ *${prefix}anagrama (1/0)*
...
┇ | 🎮⋆͜͡҈➳ *${prefix}uno* (Multiplayer)
┇ | 🎮⋆͜͡҈➳ *${prefix}roleta_mp* (Multiplayer)
┇ | 🎮⋆͜͡҈➳ *${prefix}monopoly* (Multiplayer)
┇ | 🎮⋆͜͡҈➳ *${prefix}lobisomem* (Multiplayer)
┇ | 🎮⋆͜͡҈➳ *${prefix}corrida_mp* (Multiplayer)
┇ | 🎮⋆͜͡҈➳ *${prefix}detetive* (Multiplayer)
┇╰┉━┅━┅━┅━┅━┅━┅━⋅≎⋆ᐧ
╰╼╼╼╼╼╍⋅⊹⋅⋅⦁ 🎮 ⦁⋅⋅⊹⋅╍╾╾╾╾☾⋆`;
};
